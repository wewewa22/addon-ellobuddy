...
namespace Hiện thời  sử dụng gian Skill
{
    internal static class Program
    {
        ...
        {
            get { return Menu["chế độ"].Cast<CheckBox>().CurrentValue ? 1 : 0; }
        }
        private static bool Exp
        {
            get { return Menu["vẽ kinh nghiệm"].Cast<CheckBox>().CurrentValue; }
        }
        private static bool DrawAllies
        {
            get { return Menu["vẽ tất cả các Bên"].Cast<CheckBox>().CurrentValue; }
        }
        private static bool DrawEnemies
        {
            get { return Menu["vẽ kẻ thù"].Cast<CheckBox>().CurrentValue; }
        }
        private static bool DrawText
        {
            get { return Menu["vẽ chữ"].Cast<CheckBox>().CurrentValue; }
        }
        ...
        {
            // Create the menu
            Menu = MainMenu.AddMenu("Hiện thời  sử dụng gian Skill", "Hiện thời sử dụng gian Skill");
            Menu.AddGroupLabel("Hiện thời gian sử dụng Skill");
            var mode = Menu.Add("Chế độ", new CheckBox("Sơ Chế độ thấp"));
